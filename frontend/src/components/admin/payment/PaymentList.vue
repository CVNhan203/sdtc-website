    ...
    <template v-else>
      ...
      <div class="modal" v-if="showFailedModal">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>
              Bạn có chắc chắn muốn đánh dấu thanh toán này là thất bại không?
            </p>
            <div class="form-actions">
              <button class="cancel-btn" @click="showFailedModal = false">
                Hủy
              </button>
              <button class="reject-btn" @click="handleMarkAsFailed">
                Xác nhận
              </button>
            </div>
          </div>
