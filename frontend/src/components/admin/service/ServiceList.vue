  ...
  <div class="service-list">
    ...
    <div class="modal" v-if="showSoftDeleteModal">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>
            Bạn có chắc chắn muốn chuyển dịch vụ "{{ selectedService.title }}"
            vào thùng rác không?
          </p>
          <div class="form-actions">
    ...
    <div class="modal" v-if="showRestoreModal">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>
            Bạn có chắc chắn muốn khôi phục dịch vụ "{{
    ...
    <div class="modal" v-if="showPermanentDeleteModal">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>
            Bạn có chắc chắn muốn xóa vĩnh viễn dịch vụ "{{
              selectedService.title
            }}" không?
          </p>
          <div class="form-actions">
    ...
    async loadServices() {
      ...
      try {
        ...
        const deletedServices = JSON.parse(
          localStorage.getItem("deletedServices") || "[]"
        );
    ...
    async handleSubmit() {
      try {
        ...
        if (this.formData.image instanceof File) {
          const uploadResponse = await serviceService.uploadImage(
            this.formData.image
          );
    ...
    async handleSoftDelete() {
      try {
        const serviceIndex = this.services.findIndex(
          (s) => s._id === this.selectedService._id
        );
        if (serviceIndex !== -1) {
          ...
          localStorage.setItem(
            "deletedServices",
            JSON.stringify(deletedServices)
          );
          ...
          localStorage.setItem(
            "deletedServicesInfo",
            JSON.stringify(deletedServicesInfo)
          );
