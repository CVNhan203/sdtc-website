      ...
      <div class="content-wrapper">
        ...
        <div class="trust-card">
          ...
          <div class="avatar-group">
            <img
              class="avatar"
              src="@/assets/sdtc-image/trang-chu/people/image-1.png"
              alt="avatar1"
            />
            <img
              class="avatar"
              src="@/assets/sdtc-image/trang-chu/people/image-2.png"
              alt="avatar2"
            />
            <img
              class="avatar"
              src="@/assets/sdtc-image/trang-chu/people/image-3.png"
              alt="avatar3"
            />
            <img
              class="avatar"
              src="@/assets/sdtc-image/trang-chu/people/image-4.png"
              alt="avatar4"
            />
            <img
              class="avatar"
              src="@/assets/sdtc-image/trang-chu/people/image-5.png"
              alt="avatar5"
            />
            <div class="rating">
      ...
      <div class="customer-trust-visual">
        <div class="circle-group">
          ...
          <div class="circle circle-md">
            <img src="@/assets/sdtc-image/trang-chu/people/image-10.png" alt="Khách hàng" />
          </div>
          <div class="circle circle-sm">
            <img src="@/assets/sdtc-image/trang-chu/people/image-11.png" alt="Khách hàng" />
          </div>
...
.abc {
  /* Missing asset: background: url('@/assets/sdtc-image/icon/Ellipse 38.svg'); */  background: #5DBBFF; /* Fallback color */
