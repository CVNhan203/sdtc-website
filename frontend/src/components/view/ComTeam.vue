  ...
  <div class="team-container">
    ...
    <div class="team-mission">
      <div class="img-mission">
        <!-- Replaced missing background image with a solid color background -->
...
.team-mission {
  ...
  margin-top: 50px;
  position: relative;
  background-color: #f6fbff; /* Added background color to replace missing image */
}
...
/* Removed the image reference since it's missing
.img-mission img {
  width: 100%;
  height: 100%;
  object-fit: cover;
