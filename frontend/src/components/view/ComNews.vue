<template>
  <div class="news-container">
    ...
    <!-- News grid section -->
    <div class="news-grid">
      <div v-for="(news, index) in newsItems" :key="index" class="news-card" @click="goToNewsDetail(news)">
...
.news-title{
  ...
  font-weight: 190px;
  font-size: 70px;
  line-height: 70px; /* Adjust line-height to match the height for vertical centering */
